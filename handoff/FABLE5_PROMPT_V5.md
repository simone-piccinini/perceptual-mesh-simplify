...
3. Se entrambe piccole: i 93 dei top restano inspiegati — in tal caso valuta imposter per-vista
   (componenti-rilievo, legali per la Scoperta 2) come ricerca, con read a ogni passo.
