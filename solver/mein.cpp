// C3-6840 2026-07-10: c3 6850->6840. c4@4920+c5@4165. Q: +0.0072 over 90.389474 -> 90.3967.
...
int main(int argc, char** argv) {
    ...
    if ((int)pos.size() > 7000 && (int)pos.size() <= 30000) {   // ===== PROBE-RC3-READ =====
        int c3t = 6840;                            // C3 N-PUSH below the flip wall (bank 6900; local slope 1.17e-5/v, phaseB-14 boost +8.4e-5). env G_C3T
