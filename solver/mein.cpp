// MICRO-COINS 2026-07-10: c3@6875 (window 1.45-1.8e-4) + c5@4162. c4@4930 bank. Q: 2 reads; both = +0.0046 over 90.363201.
...
int main(int argc, char** argv) {
    ...
    if ((int)pos.size() > 40000 && (int)pos.size() <= 100000) {   // ===== PROBE-RLIVE-C5 =====
        int c5t = 4162; if(const char* e=getenv("G_C5T")) c5t=atoi(e);   // c5 N-push (flip remesher; c5 has time headroom)
