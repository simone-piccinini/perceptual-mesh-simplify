...
static double keep_for(int V) {
    if (V <= 7000)   return 0.005; // case 2: PROBE 99.5% (99.25 confirmed, wall never found)
    if (V <= 30000)  return 0.3025;// case 3: PROBE 69.75% (69.5 confirmed, 70 WA'd; local 0.8984 vs 0.8974 ref)
    if (V <= 40000)  return 0.150; // case 4: PROBE 85% w/ stack (84.25 confirmed v48, wall never found; local 0.8638 > passing-base 0.8613)
    if (V <= 100000) return 0.0925;// case 5: 90.75% confirmed (90.80+stack WA'd v48, 91 WA'd twice -> wall at 90.75, CLOSED)
    if (V <= 400000) return 0.03;  // case 6: 97% confirmed (97.5% WA'd -> wall at 97)
    return 0.030;                  // case 7: PROBE 97.00% (96.95 confirmed, wall never found)
}
