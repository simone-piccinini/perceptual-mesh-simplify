...
static double keep_for(int V) {
    ...
    if (V <= 30000)  return 0.305; // case 3: PROBE 69.5% (69 confirmed; local 0.8992 > known-pass 0.8974)
    if (V <= 40000)  return 0.1590;// case 4: PROBE 84.10% w/ VSA+vis+projw stack (83.95 stack-confirmed v46; 84.25 WA'd pre-vis)
