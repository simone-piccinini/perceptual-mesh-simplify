...
static double keep_for(int V) {
    if (V <= 7000)   return 0.006; // case 2: PROBE ~99.4 w/ refine newly on (99.268@0.0075 confirmed; 99.5 WA'd refine-less)
    if (V <= 30000)  return 0.305; // case 3: 69.5 confirmed
    if (V <= 40000)  return 0.150; // case 4: 85 confirmed (razor edge, hold)
    if (V <= 100000) return 0.0875;// case 5: PROBE 91.25% (91 confirmed v64; local 0.8530 sits between two judge-passing readings)
    if (V <= 400000) return 0.0253125;// case 6: PROBE 97.46875 (97.4375 confirmed v62)
    return 0.02875;                // case 7: PROBE 97.125 (wall in (97.10,97.15))
}
