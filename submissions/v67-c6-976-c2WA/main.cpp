...
static double keep_for(int V) {
    if (V <= 7000)   return 0.007; // case 2: PROBE ~99.32 (99.268 confirmed; 0.006 WA'd -> wall in between)
    ...
    if (V <= 400000) return 0.024; // case 6: PROBE 97.6 (97.5 confirmed v66; wall unknown above -> stride)
    return 0.0286;                 // case 7: 97.14 CONFIRMED v66 (wall in (97.14,97.15) -> dust, hold)
}
