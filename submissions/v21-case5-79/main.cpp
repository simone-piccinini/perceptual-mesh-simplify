...
static double keep_for(int V) {
    if (V <= 7000)   return 0.07;  // case 2: PROBE 93% (92% confirmed)
    if (V <= 30000)  return 0.36;  // case 3: 64% confirmed (fragile anchor; gamble target, untouched here)
    if (V <= 40000)  return 0.18;  // case 4: 82% confirmed (83% AND 84% FAILED -> limit is exactly 82%)
    if (V <= 100000) return 0.21;  // case 5: PROBE 79% (78% confirmed, 80% FAILED)
