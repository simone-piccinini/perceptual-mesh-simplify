...
static double keep_for(int V) {
    ...
    if (V <= 400000) return 0.02296875;// case 6: PROBE 97.703125 (97.6875 confirmed; 97.71875 WA'd v70 -> last mid)
    return 0.028525;               // case 7: PROBE 97.1475 (97.145 confirmed v70; 97.15 WA'd -> last dust)
}
