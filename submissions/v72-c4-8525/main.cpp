...
static double keep_for(int V) {
    ...
    if (V <= 40000)  return 0.1475;// case 4: PUSH 85.25 w/ λ6 Pivot-A (validated at 85 in v71; +0.0035 local)
    if (V <= 100000) return 0.09;  // case 5: 91 CONFIRMED v64 (91.25 WA'd v65 -> CLOSED)
    if (V <= 400000) return 0.0228125;// case 6: 97.6875 CLOSED (97.703125 WA'd v71)
