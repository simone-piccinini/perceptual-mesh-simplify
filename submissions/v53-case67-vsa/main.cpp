...
static double keep_for(int V) {
    ...
    if (V <= 40000)  return 0.145; // case 4: PROBE 85.5% (85 confirmed v50; local 0.8609 vs 0.8613 floor — coin flip)
    if (V <= 100000) return 0.0925;// case 5: 90.75% confirmed (90.80+stack WA'd v48, 91 WA'd twice -> CLOSED)
    if (V <= 400000) return 0.0275;// case 6: PROBE 97.25% w/ VSA (97 confirmed base; VSA@97.25 reads above base@97 local)
    return 0.028;                  // case 7: PROBE 97.20% w/ VSA (96.95 confirmed base; VSA@97.2 reads +0.0034 above base local)
}
