...
static double keep_for(int V) {
    ...
    if (V <= 400000) return 0.02625;// case 6: PROBE 97.375% w/ VSA+refine (97.25+refine passed v55; local 0.8627 = +0.003 over anchor)
    return 0.0295;                 // case 7: PROBE 97.05% VSA-only (97.05+refine TLE v55; 97.2 VSA-only WA v53; local margin +0.0065)
}
