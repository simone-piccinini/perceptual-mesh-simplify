...
static double keep_for(int V) {
    ...
    if (V <= 30000)  return 0.300625;// case 3: MID 69.9375 w/ s-def (69.875 conf; 70 WA'd v86)
    if (V <= 40000)  return 0.145390625;// case 4: 85.4609375 CLOSED (85.46875 WA'd with both signals)
    if (V <= 100000) return 0.086875;// case 5: PUSH 91.3125 w/ s-def (91.25 confirmed v86)
