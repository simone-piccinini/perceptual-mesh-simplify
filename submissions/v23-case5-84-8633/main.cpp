...
static double keep_for(int V) {
    ...
    if (V <= 30000)  return 0.35;  // case 3: 65% CONFIRMED Pivot-A wall (66% WA'd; free-QEM was 64%)
    if (V <= 40000)  return 0.18;  // case 4: 82% confirmed (free-QEM; 83% WA'd with AND without Pivot-A)
    if (V <= 100000) return 0.16;  // case 5: PROBE 84% Pivot-A (83% CONFIRMED, free-QEM capped 79%)
