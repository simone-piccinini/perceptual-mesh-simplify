...
static double keep_for(int V) {
    ...
    if (V <= 400000) return 0.0228125;// case 6: PROBE 97.71875 (97.6875 confirmed v69; 97.75 WA'd)
    return 0.02855;                // case 7: PROBE 97.145 (97.14 confirmed; 97.15 WA'd -> last dust)
}
