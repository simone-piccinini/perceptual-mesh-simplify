...
static double keep_for(int V) {
    ...
    if (V <= 40000)  return 0.150; // case 4: 85% w/ stack CONFIRMED v50 (wall still unfound; 85.5 local-coin-flip next)
    ...
    return 0.0305;                 // case 7: 96.95% confirmed (97.00 WA'd v50 -> wall bracketed, CLOSED)
}
